...
from regression import get_residual_sum_of_squares_1
...
rss = get_residual_sum_of_squares_1(train_data['bedrooms'], train_data['price'],bedroom_intercept,bedroom_slope)
print "RSS: " + str(rss)

print("*** Comparison between sqft and bedrooms with test data")
rss = get_residual_sum_of_squares_1(test_data['sqft_living'],test_data['price'],sqft_intercept,sqft_slope)
print "RSS with sqft: " + str(rss)

rss = get_residual_sum_of_squares_1(test_data['bedrooms'],test_data['price'],bedroom_intercept,bedroom_slope)
